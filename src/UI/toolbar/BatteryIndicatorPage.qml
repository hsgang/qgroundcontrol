...
ToolIndicatorPage {
    ...
    property real   batteryCellCount: _batterySettings.batteryCellCount.rawValue
    property bool   showCellVoltage:  _batterySettings.showCellVoltage.rawValue
