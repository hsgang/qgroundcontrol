...
class VehicleEKFStatusFactGroup;
class VehicleLandingTargetFactGroup;
...
public:
    ...
    Q_PROPERTY(FactGroup*           ekfStatus       READ ekfStatusFactGroup         CONSTANT)
...
public:
    ...
    VehicleEKFStatusFactGroup*          _ekfStatusFactGroup         = nullptr;
    ...
    AtmosphericSensorFactGroup*         _atmosphericSensorFactGroup = nullptr;
    // TunnelingDataFactGroup*          _tunnelingDataFactGroup     = nullptr;
    WinchStatusFactGroup*               _winchStatusFactGroup       = nullptr;
    VehicleLandingTargetFactGroup*      _landingTargetFactGroup     = nullptr;
