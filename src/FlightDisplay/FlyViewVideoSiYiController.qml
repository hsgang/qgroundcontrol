...
Rectangle {
    ...
    Item {
        ...
        Row {
            ...
            Image {
                source: SiYi.hideWidgets ? using1080p ? "/SiYi/NavGreen.svg" : "/SiYi/NavRed.svg" : "/SiYi/nav.svg"
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: camera.aiModeOn ? (camera.isTracking ? "/SiYi/AiRed.svg" : "/SiYi/AiGreen.svg") : (aiControlMouseArea.pressed ? "/SiYi/AiGreen.svg" : "/SiYi/Ai.svg")
