...
Rectangle {
    ...
    // property real _rpm1:            _activeVehicle ? _activeVehicle.escStatus.rpmFirst.rawValue : 0
    // property real _rpm2:            _activeVehicle ? _activeVehicle.escStatus.rpmSecond.rawValue : 0
    // property real _rpm3:            _activeVehicle ? _activeVehicle.escStatus.rpmThird.rawValue : 0
    // property real _rpm4:            _activeVehicle ? _activeVehicle.escStatus.rpmFourth.rawValue : 0
    // property real _voltage1:        _activeVehicle ? _activeVehicle.escStatus.voltageFirst.rawValue : 0
    // property real _voltage2:        _activeVehicle ? _activeVehicle.escStatus.voltageSecond.rawValue : 0
    // property real _voltage3:        _activeVehicle ? _activeVehicle.escStatus.voltageThird.rawValue : 0
    // property real _voltage4:        _activeVehicle ? _activeVehicle.escStatus.voltageFourth.rawValue : 0
    ...
    // property real _temperature1:    _activeVehicle ? _activeVehicle.escStatus.temperatureFirst.rawValue : 0
    // property real _temperature2:    _activeVehicle ? _activeVehicle.escStatus.temperatureSecond.rawValue : 0
    // property real _temperature3:    _activeVehicle ? _activeVehicle.escStatus.temperatureThird.rawValue : 0
    // property real _temperature4:    _activeVehicle ? _activeVehicle.escStatus.temperatureFourth.rawValue : 0
    ...
    height:     escGrid.height + _toolsMargin * 2
    width:      escGrid.width + _toolsMargin * 2
    ...
    property var escData: [
        {rpm: _activeVehicle ? _activeVehicle.escStatus.rpmFirst.rawValue : 1100,
        ...
        {rpm: _activeVehicle ? _activeVehicle.escStatus.rpmSecond.rawValue : 1200,
        ...
        {rpm: _activeVehicle ? _activeVehicle.escStatus.rpmThird.rawValue : 1300,
        ...
        {rpm: _activeVehicle ? _activeVehicle.escStatus.rpmFourth.rawValue : 1400,
    ...
    Grid {
        ...
        property var customOrder: [2,0,1,3]
        ...
        Repeater {
            ...
            delegate: FlyViewEscIndicator {
                ...
                // escIndex: index + 1
                // rpm: escData[index].rpm
                // voltage: escData[index].voltage
                // temperature: escData[index].temperature
                // maxRpm: escStatus.maxRpm
                // maxTemperature: escStatus.maxTemperature
            }
        }
