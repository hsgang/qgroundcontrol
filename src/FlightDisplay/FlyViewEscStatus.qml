...
Rectangle {
    ...
    property var escData: [
        ...
        {rpm: _activeVehicle ? _activeVehicle.escStatus.rpmFifth.rawValue : 1500,
        ...
        {rpm: _activeVehicle ? _activeVehicle.escStatus.rpmSixth.rawValue : 1600,
        ...
        {rpm: _activeVehicle ? _activeVehicle.escStatus.rpmSeventh.rawValue : 1700,
        ...
        {rpm: _activeVehicle ? _activeVehicle.escStatus.rpmEighth.rawValue : 1800,
