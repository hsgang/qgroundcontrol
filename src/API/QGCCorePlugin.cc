...
QVariantList &QGCCorePlugin::analyzePages()
{
    if (_p->analyzeList.isEmpty()) {
        ...
        _p->analyzeList.append(QVariant::fromValue(new QmlComponentInfo(tr("Image Download"),       QUrl::fromUserInput(QStringLiteral("qrc:/qml/ImageDownloadPage.qml")),      QUrl::fromUserInput(QStringLiteral("qrc:/qmlimages/LogDownloadIcon.svg")))));
        _p->analyzeList.append(QVariant::fromValue(new QmlComponentInfo(tr("Cloud Upload"),         QUrl::fromUserInput(QStringLiteral("qrc:/qml/CloudUploadPage.qml")),        QUrl::fromUserInput(QStringLiteral("qrc:/InstrumentValueIcons/cloud-upload.svg")))));
