    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                QGCButton {
                    ...
                    text:                   qsTr("+")
                    onClicked:              if(_root.width + (2 * (_rowButtonWidth + _margins)) < screen.width) {
                                                appendColumn()
                                            }
                }
        ...
        RowLayout {
            ...
            QGCButton {
                ...
                text:                   qsTr("+")
                onClicked:              if(_root.height + (2 * (_rowButtonHeight + _margins)) < (screen.height - ScreenTools.toolbarHeight)) {
                                            appendRow()
                                        }
            }
