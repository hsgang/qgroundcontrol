...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(windowShadeLight,                 "#f5f5f5", "#f5f5f5", "#5a5a5a", "#5a5a5a")
    DECLARE_QGC_COLOR(windowShade,                      "#ebebeb", "#ebebeb", "#2f2f2f", "#2f2f2f")
    DECLARE_QGC_COLOR(windowShadeDark,                  "#bdbdbd", "#bdbdbd", "#252525", "#18181b")
    ...
    DECLARE_QGC_COLOR(buttonHighlight,                  "#e4e4e4", "#019ae8", "#262626", "#484848")
    ...
    DECLARE_QGC_COLOR(mapMissionTrajectory,             "#3db6d8", "#3db6d8", "#3db6d8", "#3db6d8")
