...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(windowShade,          "#f4f5f7", "#f4f5f7", "#252526", "#252526")
    ...
    DECLARE_QGC_COLOR(buttonBorder,         "#9d9d9d", "#cfd4d9", "#5a5a5a", "#474747")
    ...
    DECLARE_QGC_COLOR(colorYellow,          "#F7C948", "#F7C948", "#FFD60A", "#FFD60A")
    DECLARE_QGC_COLOR(colorYellowGreen,     "#6ABF40", "#6ABF40", "#7ED957", "#7ED957")
    DECLARE_QGC_COLOR(colorOrange,          "#FF9500", "#FF9500", "#FF9F0A", "#FF9F0A")
    DECLARE_QGC_COLOR(colorRed,             "#FF3B30", "#FF3B30", "#FF453A", "#FF453A")
    DECLARE_QGC_COLOR(colorGrey,            "#8E8E93", "#8E8E93", "#98989D", "#98989D")
    ...
    DECLARE_QGC_COLOR(groupBorder,          "#bbbbbb", "#d0d6dc", "#5a5a5a", "#474747")
