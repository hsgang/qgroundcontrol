...
//                                          Disabled   Enabled    Disabled   Enabled
    ...
    DECLARE_QGC_COLOR(windowTransparent,    "#ccffffff", "#ccffffff", "#cc121212", "#cc121212")
    DECLARE_QGC_COLOR(windowShadeLight,     "#909090", "#828282", "#4f4f4f", "#4f4f4f")
    DECLARE_QGC_COLOR(windowShade,          "#bdbdbd", "#bdbdbd", "#3a3a3a", "#3a3a3a")
    DECLARE_QGC_COLOR(windowShadeDark,      "#eeeeee", "#eeeeee", "#262626", "#202020")
    ...
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#000000", "#ffffff", "#ffffff")
    ...
    DECLARE_QGC_COLOR(primaryButton,        "#585858", "#1976d2", "#585858", "#1976d2")
