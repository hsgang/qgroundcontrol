        ...
        ColumnLayout {
            ...
            SettingsGroupLayout {
                ...
                FactSlider {
                    ...
                    to:                     fact.maxIsDefaultForType ? QGroundControl.unitsConversion.metersToAppSettingsDistanceUnits(121.92) : fact.max
                ...
                FactSlider {
                    ...
                    to:                     fact.maxIsDefaultForType ? QGroundControl.unitsConversion.metersToAppSettingsDistanceUnits(4) : fact.max
                    sliderPreferredWidth:   sliderWidth
