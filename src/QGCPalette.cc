...
//    DECLARE_QGC_COLOR(colorGreen, "#009431", "#009431", "#24CA95", "#24CA95")
...
//    DECLARE_QGC_COLOR(toolbarBackground,    "#ffffff", "#ffffff", "#222222", "#222222")
    ...
    DECLARE_QGC_COLOR(window, "#ffffff", "#ffffff", "#181624", "#000000")
    DECLARE_QGC_COLOR(windowShadeLight, "#d9d9d9", "#d9d9d9", "#707070", "#0b2c43")
    DECLARE_QGC_COLOR(windowShade, "#bdbdbd", "#bdbdbd", "#252638", "#071c2b")
    DECLARE_QGC_COLOR(windowShadeDark, "#828282", "#828282", "#282828", "#030c12")
    DECLARE_QGC_COLOR(text, "#9d9d9d", "#313131", "#707070", "#ffffff")
    DECLARE_QGC_COLOR(textHighlight, "#2185c8", "#2185c8", "#A0FF32", "#A0FF32")
    DECLARE_QGC_COLOR(warningText, "#cc0808", "#cc0808", "#f85761", "#f85761")
    DECLARE_QGC_COLOR(button, "#ffffff", "#ffffff", "#707070", "#092234")
    DECLARE_QGC_COLOR(buttonText, "#9d9d9d", "#000000", "#a6a6a6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight, "#e4e4e4", "#2185c8", "#3a3a3a", "#2185c8")
    DECLARE_QGC_COLOR(buttonHighlightText, "#2c2c2c", "#ffffff", "#2c2c2c", "#000000")
    ...
    DECLARE_QGC_COLOR(textFieldText, "#808080", "#000000", "#000000", "#000000")
    DECLARE_QGC_COLOR(mapButton, "#585858", "#000000", "#585858", "#000000")
    DECLARE_QGC_COLOR(mapButtonHighlight, "#585858", "#be781c", "#585858", "#2185c8")
    ...
    DECLARE_QGC_COLOR(alertBorder, "#808080", "#808080", "#808080", "#808080")
    DECLARE_QGC_COLOR(alertText, "#000000", "#000000", "#000000", "#000000")
    DECLARE_QGC_COLOR(missionItemEditor, "#585858", "#2185c8", "#585858", "#2185c8")
    DECLARE_QGC_COLOR(toolStripHoverColor, "#585858", "#9d9d9d", "#585858", "#585d83")
    DECLARE_QGC_COLOR(statusFailedText, "#9d9d9d", "#000000", "#707070", "#ffffff")
    DECLARE_QGC_COLOR(statusPassedText, "#9d9d9d", "#000000", "#707070", "#ffffff")
    DECLARE_QGC_COLOR(statusPendingText, "#9d9d9d", "#000000", "#707070", "#ffffff")
    ...
    DECLARE_QGC_COLOR(brandingBlue, "#2185c8", "#2185c8", "#2185c8", "#2185c8")
