...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,                           "#ffffff", "#ffffff", "#212121", "#212121")
    DECLARE_QGC_COLOR(windowShadeLight,                 "#d9d9d9", "#d9d9d9", "#303030", "#303030")
    DECLARE_QGC_COLOR(windowShade,                      "#bdbdbd", "#bdbdbd", "#262626", "#262626")
    DECLARE_QGC_COLOR(windowShadeDark,                  "#828282", "#828282", "#212121", "#212121")
    DECLARE_QGC_COLOR(text,                             "#9d9d9d", "#000000", "#a6a6a6", "#ffffff")
    DECLARE_QGC_COLOR(textHighlight,                    "#019ae8", "#019ae8", "#A0FF32", "#A0FF32")
    DECLARE_QGC_COLOR(warningText,                      "#cc0808", "#cc0808", "#f85761", "#f85761")
    DECLARE_QGC_COLOR(button,                           "#ffffff", "#ffffff", "#707070", "#225e99")
    DECLARE_QGC_COLOR(buttonText,                       "#9d9d9d", "#000000", "#a6a6a6", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight,                  "#e4e4e4", "#019ae8", "#262626", "#3b3b3b")
    DECLARE_QGC_COLOR(buttonHighlightText,              "#2c2c2c", "#ffffff", "#303030", "#ffffff")
